...
const StudentPassword = () => {
  ...
  const changePassword = () => {
    if (password !== confirmpassword) {
      ...
      axios.post(
        `https://fee-management-api.nastechltd.co/api/user_password/${studentid}`,
        ...
        axios
        .put(
          `https://fee-management-api.nastechltd.co/api/password/${studentid}`,
          { password: password }
        )
        // .post(https://fee-management-api.nastechltd.co/api/)
        .then((response) => {
          console.log(response);
          setPassword("");
          setConfirmpassword("");
