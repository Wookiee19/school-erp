...
const TcPrint = () => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://fee-management-api.nastechltd.co/api/issued_tc/${localStorage.getItem("TcPrint")}`
      )
      .then((response) => {
    ...
    axios
      .get(
        `https://fee-management-api.nastechltd.co/api/gr_no/${localStorage.getItem("gr_no")}`
      )
      .then((response) => {
        console.log(response);
